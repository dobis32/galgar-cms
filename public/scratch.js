...
export const TEST_TOKENS_NESTED_IF = [
    {
...
export const TEST_COMPONENT_NESTED_IF = {
...
export const TEST_PACKAGE_NESTED_IF = {
...
const testPack = TEST_PACKAGE_NESTED_IF;
const tokens = testPack.component.tokens.map((t) => t);
console.log('TEST IF STATEMENT....');
const props = testPack.component.props.map((s) => s);
const st = new SymbolTable(testPack.symbolTableStack);
const parser = new TokenParser(tokens, st, props, {});
const isControl = parser.tokenIsControlToken({
    type: _TYPE_HTML_TOKEN,
    value: '[[ #PROPS bool1, bool2, bool3 ]]',
    raw: '[[ #PROPS bool1, bool2, bool3 ]]',
    name: CONTROL_PROPS_TOKEN,
