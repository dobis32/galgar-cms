...
export const _CONTROL_NAME_MAP = {
    IF: CONTROLIF_ENDIF_TOKEN,
    ELSEIF: CONTROLIF_ENDIF_TOKEN,
    ELSE: CONTROLIF_ENDIF_TOKEN,
    ENDIF: CONTROLIF_ENDIF_TOKEN,
    FOR: CONTROLFOR_ENDFOR_TOKEN,
    ENDFOR: CONTROLFOR_ENDFOR_TOKEN,
    IMPORT: CONTROL_IMPORT_TOKEN,
    PROPS: CONTROL_PROPS_TOKEN,
    COMPONENT: CONTROL_COMPONENT_TOKEN
};
